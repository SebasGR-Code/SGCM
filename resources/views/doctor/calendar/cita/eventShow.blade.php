<div class="modal fade" id="eventoEdit" id="modalCenter" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <div class="d-flex justify-content-between">
                      ...
                      <b><i class="fas fa-user-md"></i> Paciente</b> <a class="float-right" id="paciente"></a>
                    </div>
                  </li>
                  <li class="list-group-item">
                    <div class="d-flex justify-content-between">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" id="btnTerminar">Realizar consulta</button>
        <button type="submit" class="btn btn-danger" id="btnNoAssist">Cita sin asistencia</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-header text-center bg-primary">
      ...
      <form id="formedit">
          ...
          <div class="modal-footer d-flex justify-content-center">
              <button type="submit" class="btn btn-success" id="btnTerminar">Cita terminada</button>
              <button type="submit" class="btn btn-danger" id="btnNoAssist">Cita sin asistencia</button>
          </div>
  </div>
</div>
