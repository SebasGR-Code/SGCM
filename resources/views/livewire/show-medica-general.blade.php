<div>
        ...
        <div class="d-flex justify-content-around">
            <div>
                <div class="form-check form-check-inline mt-3">
                    <input disabled class="form-check-input" type="checkbox" id="inlineCheckbox1" value="1" wire:model="fiebre">
                    <label class="form-check-label" for="inlineCheckbox1">Fiebre</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" type="checkbox" id="inlineCheckbox2" value="1" wire:model="tos">
                    <label class="form-check-label" for="inlineCheckbox2">Tos</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" type="checkbox" id="inlineCheckbox3" value="1" wire:model="cansancio">
                    <label class="form-check-label" for="inlineCheckbox3">Cansancio</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" type="checkbox" id="inlineCheckbox3" value="1" wire:model="dolor_garganta">
                    <label class="form-check-label" for="inlineCheckbox3">Dolor de garganta</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" type="checkbox" id="inlineCheckbox3" value="1" wire:model="dolor_cabeza">
                    <label class="form-check-label" for="inlineCheckbox3">Dolor de cabeza</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" type="checkbox" id="inlineCheckbox3" value="1" wire:model="perdida">
                    <label class="form-check-label" for="inlineCheckbox3">Pérdida del gusto o del olfato</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" type="checkbox" id="inlineCheckbox3" value="1" wire:model="dificultad">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                  <input readonly class="form-control" type="text" wire:model="sintoma_otro">
                </div>
            </div>
        </div>
    </div>
    <div class="row py-3 border border-solid border-dark rounded mb-3">
        ...
        <div class="col-md-3">
            ...
            <textarea readonly class="form-control" wire:model="aspecto_general"></textarea>
            <label for="defaultFormControlInput" class="form-label">Indice de masa corporal</label>
            <input readonly type="number" class="form-control" wire:model="masa_corporal">
        </div>
        <div class="col-md-3">
            <label for="defaultFormControlInput" class="form-label">Peso (Kgs)</label>
            <input readonly type="number" class="form-control" wire:model="peso">
            <label for="defaultFormControlInput" class="form-label">Talla (Mts)</label>
            <input readonly type="number" class="form-control" wire:model="talla">
        </div>
        <div class="col-md-3">
            <label for="defaultFormControlInput" class="form-label">Tension Arterial</label>
            <input readonly type="text" class="form-control" wire:model="tension_arterial">
            <label for="defaultFormControlInput" class="form-label">Frecuencia cardiaca</label>
            <input readonly type="number" class="form-control" wire:model="frecuencia_cardiaca">
        </div>
        <div class="col-md-3">
            <label for="defaultFormControlInput" class="form-label">Frecuencia respiratoria</label>
            <input readonly type="number" class="form-control" wire:model="frecuencia_respiratoria">
            <label for="defaultFormControlInput" class="form-label">Temperatura</label>
            <input readonly type="number" class="form-control" wire:model="temperatura">
        </div>
    </div>
    <div class="row py-3 border border-solid border-dark rounded mb-3">
        <h6>Examen Fisico</h6>
        <div class="col-md-4">
            ...
            <textarea readonly class="form-control" wire:model="cabeza_cuello"></textarea>
            <label for="defaultFormControlInput" class="form-label">Ojos y fondo de ojos</label>
            <textarea readonly class="form-control" wire:model="ojos"></textarea>
        </div>
        <div class="col-md-4">
            <label for="defaultFormControlInput" class="form-label">Cardíaco</label>
            <textarea readonly class="form-control" wire:model="cardiaco"></textarea>
            <label for="defaultFormControlInput" class="form-label">Pulmonar</label>
            <textarea readonly class="form-control" wire:model="pulmonar"></textarea>
        </div>
        <div class="col-md-4">
            <label for="defaultFormControlInput" class="form-label">Abdomen</label>
            <textarea readonly class="form-control" wire:model="abdomen"></textarea>
            <label for="defaultFormControlInput" class="form-label">Mental</label>
            <textarea readonly class="form-control" wire:model="mental"></textarea>
        </div>
    </div>
    <div class="row py-3 border border-solid border-dark rounded mb-3">
        ...
        <div class="col-md-6">
            ...
            <textarea readonly class="form-control" wire:model="analisis_plan"></textarea>
            @error('analisis_plan')
